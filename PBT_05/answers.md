...
/* Định nghĩa cấu trúc khung chính của trang (1 cột) */
.restaurant-page {
    display: grid;
    grid-template-columns: 1fr;
    
    /* Bản đồ bị loại khỏi areas để ẩn đi trên Mobile */
    grid-template-areas:
        "header"
        "hero"
        "booking-form"
...
.map          { grid-area: map; display: none; } /* Ẩn map trên Mobile */
.footer       { grid-area: footer; }

/* Lưới món ăn trên Mobile: 2 cột */
.food-grid {
    display: grid;
